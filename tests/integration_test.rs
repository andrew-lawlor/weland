...
fn create_test_epub(file_path: &Path) {
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="pub-id">
  ...
  <spine>
    ...
    zip.write_all(&[0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x01, 0x02, 0x03]).unwrap();

    // 5. Dummy diagram image
    zip.start_file("OEBPS/images/diagram.png", deflated_opts).unwrap();
    zip.write_all(&[0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0xAA, 0xBB, 0xCC, 0xDD]).unwrap();
